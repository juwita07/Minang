...
public class DatabaseManager {
	...
	private static final String ROW_MINANG = "minang";
	...
	private static class DatabaseOpenHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			...
			values.put(ROW_INDO, "Aku");
			values.put(ROW_MINANG, "Aden");
			db.insert(NAMA_TABEL, null, values);
			values.put(ROW_INDO, "Menghambat");
			values.put(ROW_MINANG, "Maambek");
			db.insert(NAMA_TABEL, null, values);
			values.put(ROW_INDO, "Enam");
			values.put(ROW_MINANG, "Anam");
			db.insert(NAMA_TABEL, null, values);
	...
	public ArrayList<ArrayList<Object>> ambilSemuaBaris() {
		...
		Cursor cur;
		try {
			cur = db.query(NAMA_TABEL, new String[] { ROW_INDO, ROW_MINANG },
